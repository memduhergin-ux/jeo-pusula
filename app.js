...
const CACHE_NAME = 'jeocompass-v87';
    ...
    if (utmEl) {
        ...
        if (displayLat) {
            ...
            try {
                ...
                utmEl.innerHTML = `
                    <span style="font-size:0.75em; margin-right:1mm;">${modeLabel}</span>
                    ...
                    <span style="font-size:0.7em; color:#ddd; margin-right:1px;">Z:</span>${displayAlt}
                `;
            } catch (e) {
